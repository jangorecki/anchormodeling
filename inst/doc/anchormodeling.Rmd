...
Duplicates insert was handled automatically.  
...
am
am$etl
am$log # you should notice your OS user name on `meta==1L`
am$IM()
```
...
![Git repo AM first iteration](/path/git-am1.png)
...
Limited by `--before="2015-01-01"`. All historical data duplicates will be handled.   
